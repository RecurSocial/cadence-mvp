  ...
  return (
    <div className="px-8 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-display text-3xl text-ink-primary">Vendors &amp; Suppliers</h1>
          <p className="mt-1 text-sm text-ink-muted">{vendors.length} vendors configured</p>
        </div>
      ...
      {loading ? (
        <div className="text-center py-12 text-ink-muted">Loading vendors...</div>
      ) : (
