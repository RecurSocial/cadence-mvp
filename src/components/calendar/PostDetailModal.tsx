  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4">
        {/* Header with post type color bar */}
          ...
          {mode === 'edit' && (
            <div className="space-y-4">
              ...
              <div className="flex gap-3 justify-end pt-2 border-t border-[#E2E8F0]">
                ...
                <button onClick={handleSave} disabled={saving} className="px-4 py-2 bg-[#4F46E5] hover:bg-[#4338CA] text-white rounded-lg text-sm font-medium disabled:opacity-50 transition">
