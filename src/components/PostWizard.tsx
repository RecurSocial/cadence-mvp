...
const POST_TYPES = [
  { value: 'educational', label: '📚 Educational', description: 'Teach your audience about a service or treatment' },
  { value: 'promotional', label: '🏷️ Promotional', description: 'Announce an offer, deal, or package' },
  { value: 'before_after', label: '✨ Before & After', description: 'Showcase a client transformation' },
  { value: 'practitioner_spotlight', label: '👩‍⚕️ Practitioner Spotlight', description: 'Introduce or highlight a team member' },
  { value: 'service_feature', label: '💉 Service Feature', description: 'Deep-dive on a specific service' },
  { value: 'seasonal', label: '🌸 Seasonal', description: 'Tie content to a season or holiday' },
  { value: 'event', label: '🎉 Event', description: 'Promote an upcoming event with a full campaign' },
  { value: 'trend_viral', label: '🔥 Trend / Viral', description: 'Ride a trend to reach new audiences' },
]
const TONES = [
