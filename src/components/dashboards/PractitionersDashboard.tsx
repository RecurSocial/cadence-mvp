...
export default function PractitionersDashboard({ orgId }: { orgId: string }) {
  ...
  if (loading) return <div className="text-center py-12 text-ink-muted">Loading practitioners...</div>;

  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="font-display text-2xl text-ink-primary">Practitioners</h2>
          <p className="mt-0.5 text-sm text-ink-muted">{practitioners.length} practitioners active</p>
        </div>
